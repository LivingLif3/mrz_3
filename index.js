...
class NeuralNetwork {
    ...
    backPropagate(vectorOfColor, forwardedMatrices) {
        ...
        this.weights[1] = subtractMatrices(
            this.weights[1],
            transposeMattrix(multiplyByNumber(multiplyMatrices(transposeMattrix(deltaLastLayer), firstLayerMattrix), this.learningRate))
        );
        ...
        console.log(multiplyByNumber(multiplyMatrices(transposeMattrix(vectorOfColor), deltaFirstLayer), this.learningRate), "DSadas")
